import { BookOpen, Download, Users, Sparkles, GraduationCap, Palette, Calendar, ArrowRight, Mail, Phone, MapPin, Facebook, Instagram, Linkedin, Grid, Star, Clock, TrendingUp, Heart, Gift, Baby, Scissors, Music, TreePine, Eye } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#latest" className="text-gray-700 hover:text-emerald-600 transition">Latest</a>
              <a href="#team" className="text-gray-700 hover:text-emerald-600 transition">Team</a>
      ...
      <section id="home" className="relative bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 py-20 overflow-hidden">
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4 mt-8">
                  <div className="bg-white rounded-2xl shadow-xl p-4 transform hover:scale-105 transition">
                    <div className="aspect-[3/4] bg-gradient-to-br from-purple-200 to-violet-300 rounded-xl flex items-center justify-center">
      ...
      <section id="latest" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {latestPosts.map((post) => (
                <div key={post.id} className="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="text-emerald-600 font-semibold text-sm flex items-center space-x-1 group-hover:space-x-2 transition-all">
                        <span>Read</span>
          ...
          <div className="text-center mt-12">
            <button className="bg-emerald-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition shadow-lg inline-flex items-center space-x-2">
          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {popularPosts.map((post, index) => (
                <div key={post.id} className="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition relative">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="text-emerald-600 font-semibold flex items-center space-x-2 group-hover:space-x-3 transition-all">
                        <span>Read More</span>
                        <ArrowRight className="w-4 h-4" />
                      </button>
                    </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold text-white">Print<span className="text-emerald-500">&</span>Use</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#home" className="hover:text-emerald-500 transition">Home</a></li>
                ...
                <li><a href="#team" className="hover:text-emerald-500 transition">Team</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-emerald-500 transition">Coloring Pages</a></li>
                <li><a href="#" className="hover:text-emerald-500 transition">Activity Books</a></li>
                <li><a href="#" className="hover:text-emerald-500 transition">Puzzles</a></li>
                <li><a href="#" className="hover:text-emerald-500 transition">Generators</a></li>
              </ul>
            </div>
