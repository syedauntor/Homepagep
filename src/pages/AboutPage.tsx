      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-orange-500 font-semibold text-sm tracking-wider uppercase">Our Story</span>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-gradient-to-br from-orange-200 to-amber-300 rounded-2xl aspect-square"></div>
                  <div className="bg-gradient-to-br from-blue-200 to-cyan-300 rounded-2xl aspect-[4/3]"></div>
                </div>
                <div className="space-y-4 mt-8">
                  <div className="bg-gradient-to-br from-green-200 to-emerald-300 rounded-2xl aspect-[4/3]"></div>
                  <div className="bg-gradient-to-br from-yellow-200 to-orange-300 rounded-2xl aspect-square"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-orange-500 font-semibold text-sm tracking-wider uppercase">Our Values</span>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-500 to-amber-500 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-orange-500 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg">
              Start Exploring
            </button>
            <button className="bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-orange-700 transition border-2 border-white">
              Contact Us
            </button>
          </div>
        </div>
