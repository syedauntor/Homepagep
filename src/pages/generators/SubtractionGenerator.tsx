...
export function SubtractionGenerator() {
  const [title, setTitle] = useState('Subtraction Generator');
  ...
  const handleReset = () => {
    setTitle('Subtraction Generator');
    ...
    const problemsHtml = orientation === 'horizontal'
      ...
      : Array.from({ length: 5 }, (_, rowIndex) => {
          ...
          const cols = [0, 1, 2, 3].map((colIndex) => {
            ...
            if (index >= problems.length) return '<div style="visibility:hidden"><div style="min-width:90px;display:inline-block"><div style="font-size:24px;text-align:right;padding-right:4px">0</div><div style="font-size:24px;text-align:right;padding-right:4px">&#8722; 0</div><div style="border-top:2px solid #111;margin-top:4px;padding-top:8px"></div></div></div>';
            const p = problems[index];
            const answerPart = displayAnswers
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-gray-900 font-medium">Subtraction Generator</span>
        </div>

        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Subtraction Generator</h1>
            ...
            {activeNavTab === 'generator' ? (
              ...
              <div className="flex space-x-4 pt-4">
                ...
                >
                  ...
                  <span>Regenerate Subtraction</span>
                </button>
              </div>
            </div>
              </>
              ...
              <>
                <h2 className="text-lg font-bold text-gray-900 mb-6">Select Subtraction Worksheet Theme</h2>
              ...
              <>
                <h2 className="text-lg font-bold text-gray-900 mb-6">How to Make Subtraction Worksheets</h2>
                <div className="prose prose-sm text-gray-700 space-y-4">
                  <ol className="list-decimal list-inside space-y-3">
                    ...
                    <li>Click "Regenerate Subtraction" to create new problems</li>
