...
export function MultiplicationGenerator() {
  const [title, setTitle] = useState('Multiplication Generator');
  ...
  const generateProblems = () => {
    ...
    let max1: number, min1: number, max2: number, min2: number;
  ...
  const handleReset = () => {
    setTitle('Multiplication Generator');
    ...
    const problemsHtml = orientation === 'horizontal'
          ...
          const cols = [0, 1].map((colIndex) => {
            ...
            return `<div class="problem-col" style="text-align:left">
              <div style="display:flex;align-items:center;gap:12px;font-size:20px">
                ...
                <span>${p.num1}</span><span>&times;</span><span>${p.num2}</span><span>=</span>${answerPart}
              </div>
            </div>`;
          });
      ...
      : Array.from({ length: 5 }, (_, rowIndex) => {
          ...
          const cols = [0, 1, 2, 3].map((colIndex) => {
            ...
            if (index >= problems.length) return '<div style="visibility:hidden"><div style="min-width:90px;display:inline-block"><div style="font-size:24px;text-align:right;padding-right:4px">0</div><div style="font-size:24px;text-align:right;padding-right:4px">&times; 0</div><div style="border-top:2px solid #111;margin-top:4px;padding-top:8px"></div></div></div>';
            const p = problems[index];
            const answerPart = displayAnswers
            ...
            return `<div>
              ...
              <div style="min-width:90px;display:inline-block">
                ...
                <div style="font-size:24px;text-align:right;display:flex;justify-content:flex-end">
                  <span style="margin-right:4px">&times;</span><span style="padding-right:4px">${p.num2}</span>
                </div>
                ${answerPart}
              </div>
            </div>`;
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-gray-900 font-medium">Multiplication Generator</span>
        </div>

        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Multiplication Generator</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-orange-50 rounded-2xl shadow-sm p-8">
            {activeNavTab === 'generator' ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        <option value="simple">Simple (0–9 × 0–9)</option>
                        <option value="medium">Medium (2–12 × 2–12)</option>
                        <option value="hard">Hard (10–99 × 2–12)</option>
                      </select>
                    </div>
                  ...
                  <div className="flex space-x-4 pt-4">
                    ...
                    >
                      ...
                      <span>Regenerate Multiplication</span>
                    </button>
                  </div>
                </div>
              </>
              ...
              <>
                <h2 className="text-lg font-bold text-gray-900 mb-6">Select Multiplication Worksheet Theme</h2>
              ...
              <>
                <h2 className="text-lg font-bold text-gray-900 mb-6">How to Make Multiplication Worksheets</h2>
                <div className="prose prose-sm text-gray-700 space-y-4">
                  <ol className="list-decimal list-inside space-y-3">
                    ...
                    <li>Click "Regenerate Multiplication" to create new problems</li>
                              ...
                              {Array.from({ length: 5 }, (_, rowIndex) => (
                                <div key={rowIndex} className="flex justify-between w-full">
                                  {[0, 1, 2, 3].map((colIndex) => {
                                    const index = rowIndex * 4 + colIndex;
                                    if (index >= problems.length) return <div key={colIndex} className="invisible"><div className="inline-block min-w-[90px]"><div className="text-2xl text-right pr-1">0</div><div className="text-2xl text-right pr-1">&times; 0</div><div className="border-t-2 border-gray-900 mt-1 pt-2"></div></div></div>;
                                    const problem = problems[index];
                                    return (
                                      <div key={index}>
